...
import (
	...
	"github.com/golang/protobuf/protoc-gen-go-netrpc/generator/internal/remap"

	"github.com/golang/protobuf/protoc-gen-go-netrpc/descriptor"
	plugin "github.com/golang/protobuf/protoc-gen-go-netrpc/plugin"
)

func init() {
	fmt.Fprint(os.Stderr,
		"WARNING: Package \"github.com/golang/protobuf/protoc-gen-go-netrpc/generator\" is deprecated.\n"+
...
func (g *Generator) Error(err error, msgs ...string) {
	...
	log.Print("protoc-gen-go-netrpc: error:", s)
	os.Exit(1)
}
